            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} title="Create Order">
                <div>
                    ...
                    <div className="flex items-center bg-[#1f1f1f] p-3 px-4 rounded-lg">
                        <input type="text" className="bg-transparent flex-1 text-white focus:outline-none" placeholder="Enter customer name" />
                    </div>
                </div>
                <div>
                    ...
                    <div className="flex items-center justify-between bg-[#1f1f1f] py-3 px-4 rounded-lg">
                        <input type="phone number" className="bg-transparent flex-1 text-white focus:outline-none" placeholder="Phone no:" />
                    </div>
                </div>
                <button onClick={() => navigate("/menu")} className="w-full bg-[#F6B100] text-[#f5f5f5] rounded-lg py-3 mt-6 hover:bg-yellow-700">
                    Create Order
                </button>
            </Modal>
        </div>
